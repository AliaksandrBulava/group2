package modeule01.task1.dao.db;
...
import module04.task5.db.Facade;
...
public class DbPersonDao extends AbstractDbDao implements PersonDao {
    ...
    public DbPersonDao() {
        ...
        try {
            Facade.registerDriver();
            connection = Facade.getConnection(CONNECTION_URL);
            statement = Facade.createStatement(connection);
            Facade.executeUpdate(statement, CREATE_SCRIPT);
